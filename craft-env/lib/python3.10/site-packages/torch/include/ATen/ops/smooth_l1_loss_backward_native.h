...
TORCH_API at::Tensor & smooth_l1_loss_backward_out_mps(const at::Tensor & grad_output, const at::Tensor & self, const at::Tensor & target, int64_t reduction, double beta, at::Tensor & grad_input);
} // namespace native
} // namespace at
