...
TORCH_API at::Tensor & _amp_update_scale_mps_(at::Tensor & self, at::Tensor & growth_tracker, const at::Tensor & found_inf, double scale_growth_factor, double scale_backoff_factor, int64_t growth_interval);
} // namespace native
} // namespace at
