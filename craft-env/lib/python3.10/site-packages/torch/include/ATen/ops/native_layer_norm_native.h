...
TORCH_API ::std::tuple<at::Tensor,at::Tensor,at::Tensor> layer_norm_mps(const at::Tensor & input, at::IntArrayRef normalized_shape, const ::std::optional<at::Tensor> & weight, const ::std::optional<at::Tensor> & bias, double eps);
