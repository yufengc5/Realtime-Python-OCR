...
TORCH_API at::Tensor max_unpooling2d_forward_mps(const at::Tensor & self, const at::Tensor & indices, at::IntArrayRef output_size);
TORCH_API at::Tensor & max_unpooling2d_forward_out_mps(const at::Tensor & self, const at::Tensor & indices, at::IntArrayRef output_size, at::Tensor & out);
} // namespace native
} // namespace at
